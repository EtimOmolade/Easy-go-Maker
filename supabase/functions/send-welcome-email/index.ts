              ...
              <table role="presentation" style="width: 600px; max-width: 100%; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                ...
                <tr>
                  <td style="padding: 40px 40px 30px; text-align: center; background: linear-gradient(135deg, #7E69AB 0%, #9b87c5 100%); border-radius: 8px 8px 0 0;">
                    <h1 style="margin: 0; color: #ffffff; font-size: 32px; font-weight: 600;">🕊️ Welcome to SpiritConnect</h1>
                    <p style="margin: 12px 0 0; color: #f0e6ff; font-size: 16px;">Your journey of daily prayer begins today</p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding: 40px;">
                    ...
                    <table role="presentation" style="width: 100%; margin: 0 0 32px;">
                      <tr>
                        <td style="padding: 16px; background-color: #f8f5ff; border-radius: 6px; margin-bottom: 12px;">
                          <p style="margin: 0; color: #7E69AB; font-size: 16px; font-weight: 600;">📖 Daily Guidelines</p>
                      ...
                      <tr>
                        <td style="padding: 16px; background-color: #f8f5ff; border-radius: 6px; margin-bottom: 12px;">
                          <p style="margin: 0; color: #7E69AB; font-size: 16px; font-weight: 600;">✍️ Prayer Journal</p>
                          <p style="margin: 8px 0 0; color: #666666; font-size: 14px; line-height: 1.5;">
                      ...
                      <tr><td style="height: 12px;"></td></tr>
                      <tr>
                        <td style="padding: 16px; background-color: #f8f5ff; border-radius: 6px;">
                          <p style="margin: 0; color: #7E69AB; font-size: 16px; font-weight: 600;">🔥 Build Your Streak</p>
                          <p style="margin: 8px 0 0; color: #666666; font-size: 14px; line-height: 1.5;">
                    ...
                    <!-- Tips -->
                    <table role="presentation" style="width: 100%; margin: 24px 0 0; padding: 20px; background-color: #fff8e6; border-radius: 6px; border-left: 4px solid #f59e0b;">
                      <tr>
                        <td>
                          <p style="margin: 0; color: #d97706; font-size: 14px; font-weight: 600;">💡 Quick Tip</p>
